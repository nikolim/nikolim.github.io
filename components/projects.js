...
import greenIT from "../public/images/projects/greenIT.jpg";
...
const PrometheusBadge = function () {
    return (<span className={`bg-purple-100 text-purple-800 ${commonBadgeStyle}`} key={"influx"}>Prometheus</span>);
}
...
const DevOpsBadge = function () {
    return (<span className={`bg-green-100 text-green-800 ${commonBadgeStyle}`} key={"nodejs"}>DevOps</span>);
}

const CloudBadge = function () {
    return (<span className={`bg-blue-100 text-blue-800 ${commonBadgeStyle}`} key={"tailwind"}>Cloud</span>);
}
        ...
        <div className="flex-col pt-9 flex align-center" id="projects">
            ...
            <div
                ...
                <Card name={"CI/CD Energy Measurements"}
                      ...
                      badges={[DevOpsBadge, CloudBadge, PrometheusBadge, GrafanaBadge, PythonBadge, GolangBadge]}
                />
